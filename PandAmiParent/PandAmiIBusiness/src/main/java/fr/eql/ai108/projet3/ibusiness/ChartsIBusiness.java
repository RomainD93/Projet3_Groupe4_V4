...
public interface ChartsIBusiness {
	Long displayNumberServicesCat1();
	Long displayNumberServicesCat2();
	Long displayNumberServicesCat3();
	Long displayNumberServicesCat4();
	Long displayNumberServicesCat5();
	Long displayNumberServicesCat6();
	Long displayNumberServicesCat7();
	Long displayNumberServicesCat8();
